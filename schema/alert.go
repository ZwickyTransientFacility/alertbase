...
type Alert struct {
	// schema version used
	Schemavsn string `json:"schemavsn"`
	...
	Prv_candidates *UnionNullArrayPrv_candidate `json:"prv_candidates"`

	CutoutScience *UnionNullCutout `json:"cutoutScience"`

	CutoutTemplate *UnionNullCutout `json:"cutoutTemplate"`

	CutoutDifference *UnionNullCutout `json:"cutoutDifference"`
}
...
func (r *Alert) Get(i int) types.Field {
	switch i {
	case 0:
		return &types.String{Target: &r.Schemavsn}
	case 1:
		return &types.String{Target: &r.Publisher}
	case 2:
		return &types.String{Target: &r.ObjectId}
	case 3:
...
func (r *Alert) SetDefault(i int) {
	switch i {
	case 5:
		r.Prv_candidates = nil
		return
	case 6:
		r.CutoutScience = nil
		return
	case 7:
		r.CutoutTemplate = nil
		return
	case 8:
		r.CutoutDifference = nil
		return
	}
	panic("Unknown field index")
}
