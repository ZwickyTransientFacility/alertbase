...
type Prv_candidate struct {
	...
	Ra *UnionNullDouble `json:"ra"`
	// Declination of candidate; J2000 [deg]
	Dec *UnionNullDouble `json:"dec"`
	// Magnitude from PSF-fit photometry [mag]
	Magpsf *UnionNullFloat `json:"magpsf"`
	// 1-sigma uncertainty in magpsf [mag]
	Sigmapsf *UnionNullFloat `json:"sigmapsf"`
...
func (r *Prv_candidate) NullField(i int) {
	switch i {
	case 3:
		r.Diffmaglim = nil
		return
